      ...
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom }} contentContainerClassName="bg-shade-1">
        ...
        <View>
          <View className="flex-row align-middle">
            <Text className="flex-1 font-semibold text-3xl px-4 py-2 bg-shade-2">{work?.title}</Text>
            <View className="justify-center px-6 gap-x-3 flex-row items-center">
              <Pressable
          ...
          <View className="px-4 gap-y-2 py-2">
            {work?.creators.length ? <Text className="text-l">{work.creators[0].description}</Text> : null}
